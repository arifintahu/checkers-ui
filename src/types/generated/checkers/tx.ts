...
export const MsgRejectGame = {
  ...
  fromPartial<I extends Exact<DeepPartial<MsgRejectGame>, I>>(
    object: I
  ): MsgRejectGame {
    const message = createBaseMsgRejectGame();
    message.creator = object.creator ?? "";
...
export const MsgRejectGameResponse = {
  ...
  fromPartial<I extends Exact<DeepPartial<MsgRejectGameResponse>, I>>(
    _: I
  ): MsgRejectGameResponse {
    const message = createBaseMsgRejectGameResponse();
    return message;
...
export class MsgClientImpl implements Msg {
  ...
  RejectGame(request: MsgRejectGame): Promise<MsgRejectGameResponse> {
    ...
    return promise.then((data) =>
      MsgRejectGameResponse.decode(new _m0.Reader(data))
    );
  }
}
